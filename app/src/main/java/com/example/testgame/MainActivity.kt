...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        random()
//
//        rad_a.setOnClickListener(View.OnClickListener {
...
//        })
        ...
        btn_keyingi.setOnClickListener(View.OnClickListener {
            ...
            if (radBtnChekedJavob == radBtnJavob) {
                ...
                view[viewIndex].setBackgroundResource(R.drawable.fon_javob_1)

                togriJavobSoni++
            } else {
                Toast.makeText(this, "Noto'g'ri javob", Toast.LENGTH_SHORT).show()

                view[viewIndex].setBackgroundResource(R.drawable.font0)
